...
def mondayy1(record1):
	...
	if(cntm == 0):
		...
		cntm+=1
	elif((cntm == 5) or (cntm == 6)):
		if(cntm == 5):
			m6.insert(3, "B1:%s" %record1[0])
			m6.insert(10, "(%s)" %record1[1])
		else:
			m6.insert(15, "B2:%s" %record1[0])
			m6.insert(20, "(%s)" %record1[1])
		cntm+=1
	elif((cntm == 7) or (cntm == 8)):
		if(cntm == 7):
			m7.insert(3, "B3:%s" %record1[0])
			m7.insert(10, "(%s)" %record1[1])
		else:
			m7.insert(15, "B4:%s" %record1[0])
			m7.insert(20, "(%s)" %record1[1])
		cntm+=1
...
def mondayy2(record1):
	...
	if(cntm2 == 0):
		...
		cntm2+=1
	elif((cntm2 == 5) or (cntm2 == 6)):
		if(cntm2 == 5):
			m62.insert(3, "B1:%s" %record1[0])
			m62.insert(10, "(%s)" %record1[1])
		else:
			m62.insert(15, "B2:%s" %record1[0])
			m62.insert(20, "(%s)" %record1[1])
		cntm2+=1
	elif((cntm2 == 7) or (cntm2 == 8)):
		if(cntm2 == 7):
			m72.insert(3, "B3:%s" %record1[0])
			m72.insert(10, "(%s)" %record1[1])
		else:
			m72.insert(15, "B4:%s" %record1[0])
			m72.insert(20, "(%s)" %record1[1])
		cntm2+=1
...
def mondayy3(record1):
	...
	if(cntm3 == 0):
		...
		cntm3+=1
	elif((cntm3 == 2) or (cntm3 == 3)):
		if(cntm3 == 2):
			m33.insert(3, "B1:%s" %record1[0])
			m33.insert(10, "(%s)" %record1[1])
		else:
			m33.insert(16, "B2:%s" %record1[0])
			m33.insert(20, "(%s)" %record1[1])
		cntm3+=1
	elif((cntm3 == 4)):
		m43.delete(0, "end")
		m43.insert(3, "B3:%s" %record1[0])
...
def tuesdayy1(record1):
	...
	if(cntt == 0):
		...
		cntt+=1
	elif((cntt == 5) or (cntt == 6)):
		if(cntt == 5):
			t6.insert(3, "B1:%s" %record1[0])
			t6.insert(10, "(%s)" %record1[1])
		else:
			t6.insert(15, "B2:%s" %record1[0])
			t6.insert(20, "(%s)" %record1[1])
		cntt+=1
	elif((cntt == 7) or (cntt == 8)):
		if(cntt == 7):
			t7.insert(3, "B3:%s" %record1[0])
			t7.insert(10, "(%s)" %record1[1])
		else:
			t7.insert(15, "B4:%s" %record1[0])
			t7.insert(20, "(%s)" %record1[1])
...
def tuesdayy2(record1):
	...
	if(cntt2 == 0):
		...
		cntt2+=1
	elif((cntt2 == 5) or (cntt2 == 6)):
		if(cntt2 == 5):
			t62.insert(3, "B1:%s" %record1[0])
			t62.insert(10, "(%s)" %record1[1])
		else:
			t62.insert(15, "B2:%s" %record1[0])
			t62.insert(20, "(%s)" %record1[1])
		cntt2+=1
	elif((cntt2 == 7) or (cntt2 == 8)):
		if(cntt2 == 7):
			t72.insert(3, "B3:%s" %record1[0])
			t72.insert(10, "(%s)" %record1[1])
		else:
			t72.insert(15, "B4:%s" %record1[0])
			t72.insert(20, "(%s)" %record1[1])
...
def tuesdayy3(record1):
	...
	if(cntt3 == 0):
		...
		cntt3+=1
	elif((cntt3 == 2) or (cntt3 == 3)):
		if(cntt3 == 4):
			t33.insert(3, "B1:%s" %record1[0])
			t33.insert(10, "(%s)" %record1[1])
		else:
			t33.insert(16, "B2:%s" %record1[0])
			t33.insert(20, "(%s)" %record1[1])
		cntt3+=1
	elif((cntt3 == 4)):
		t43.delete(0, "end")
		t43.insert(3, "B3:%s" %record1[0])
...
def wednesdayy1(record1):
	...
	if(cntw == 0):
		...
		cntw+=1
	elif((cntw == 5) or (cntw == 6)):
		if(cntw == 5):
			w6.insert(3, "B1:%s" %record1[0])
			w6.insert(10, "(%s)" %record1[1])
		else:
			w6.insert(15, "B2:%s" %record1[0])
			w6.insert(20, "(%s)" %record1[1])
		cntw+=1
	elif((cntw == 7) or (cntw == 8)):
		if(cntw == 7):
			w7.insert(3, "B3:%s" %record1[0])
			w7.insert(10, "(%s)" %record1[1])
		else:
			w7.insert(15, "B4:%s" %record1[0])
			w7.insert(20, "(%s)" %record1[1])
...
def wednesdayy2(record1):
	...
	if(cntw2 == 0):
		...
		cntw2+=1
	elif((cntw2 == 5) or (cntw2 == 6)):
		if(cntw2 == 5):
			w62.insert(3, "B1:%s" %record1[0])
			w62.insert(10, "(%s)" %record1[1])
		else:
			w62.insert(15, "B2:%s" %record1[0])
			w62.insert(20, "(%s)" %record1[1])
		cntw2+=1
	elif((cntw2 == 7) or (cntw2 == 8)):
		if(cntw2 == 7):
			w72.insert(3, "B3:%s" %record1[0])
			w72.insert(10, "(%s)" %record1[1])
		else:
			w72.insert(15, "B4:%s" %record1[0])
			w72.insert(20, "(%s)" %record1[1])
...
def wednesdayy3(record1):
	...
	if(cntw3 == 0):
		...
		cntw3+=1
	elif((cntw3 == 2) or (cntw3 == 3)):
		if(cntw3 == 4):
			w33.insert(3, "B1:%s" %record1[0])
			w33.insert(10, "(%s)" %record1[1])
		else:
			w33.insert(16, "B2:%s" %record1[0])
			w33.insert(20, "(%s)" %record1[1])
		cntw3+=1
	elif((cntw3 == 4)):
		w43.delete(0, "end")
		w43.insert(3, "B3:%s" %record1[0])
...
def thursdayy1(record1):
	...
	if(cntth == 0):
		...
		cntth+=1
	elif((cntth == 5) or (cntth == 6)):
		if(cntth == 5):
			th6.insert(3, "B1:%s" %record1[0])
			th6.insert(10, "(%s)" %record1[1])
		else:
			th6.insert(15, "B2:%s" %record1[0])
			th6.insert(20, "(%s)" %record1[1])
		cntth+=1
	elif((cntth == 7) or (cntth == 8)):
		if(cntth == 7):
			th7.insert(3, "B3:%s" %record1[0])
			th7.insert(10, "(%s)" %record1[1])
		else:
			th7.insert(15, "B4:%s" %record1[0])
			th7.insert(20, "(%s)" %record1[1])
...
def thursdayy2(record1):
	...
	if(cntth2 == 0):
		...
		cntth2+=1
	elif((cntth2 == 5) or (cntth2 == 6)):
		if(cntth2 == 5):
			th62.insert(3, "B1:%s" %record1[0])
			th62.insert(10, "(%s)" %record1[1])
		else:
			th62.insert(15, "B2:%s" %record1[0])
			th62.insert(20, "(%s)" %record1[1])
		cntth2+=1
	elif((cntth2 == 7) or (cntth2 == 8)):
		if(cntth2 == 7):
			th72.insert(3, "B3:%s" %record1[0])
			th72.insert(10, "(%s)" %record1[1])
		else:
			th72.insert(15, "B4:%s" %record1[0])
			th72.insert(20, "(%s)" %record1[1])
...
def thursdayy3(record1):
	...
	if(cntth3 == 0):
		...
		cntth3+=1
	elif((cntth3 == 2) or (cntth3 == 3)):
		if(cntth3 == 4):
			th33.insert(3, "B1:%s" %record1[0])
			th33.insert(10, "(%s)" %record1[1])
		else:
			th33.insert(16, "B2:%s" %record1[0])
			th33.insert(20, "(%s)" %record1[1])
		cntth3+=1
	elif((cntth3 == 4)):
		th43.delete(0, "end")
		th43.insert(3, "B3:%s" %record1[0])
...
def fridayy2(record1):
	...
	if(cntf2 == 0):
		...
		if(cntf2 == 5):
			f52.insert(3, "B1:%s" %record1[0])
			f52.insert(10, "(%s)" %record1[1])
		else:
			f52.insert(15, "B2:%s" %record1[0])
			f52.insert(20, "(%s)" %record1[1])
		cntf2+=1
	elif((cntf2 == 6) or (cntf2 == 7)):
		if(cntf2 == 7):
			f62.insert(3, "B3:%s" %record1[0])
			f62.insert(10, "(%s)" %record1[1])
		else:
			f62.insert(15, "B4:%s" %record1[0])
			f62.insert(20, "(%s)" %record1[1])

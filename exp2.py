...
def pri():
	...
	while(len(monday0) < 7):
		monday0.append("13")
	while(len(tuesday0) < 7):
		tuesday0.append("13")
	while(len(wednesday0) < 7):
		wednesday0.append("13")
	while(len(thursday0) < 7):
		thursday0.append("13")
	while(len(friday0) < 7):
		friday0.append("13")
...
#============================================================================================================================
	...
	while(len(monday1) < 7):
		monday1.append("13")
	while(len(tuesday1) < 7):
		tuesday1.append("13")
	while(len(wednesday1) < 7):
		wednesday1.append("13")
	while(len(thursday1) < 7):
		thursday1.append("13")
	while(len(friday1) < 7):
		friday1.append("13")
